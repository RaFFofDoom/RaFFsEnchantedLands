    ...
    public partial class TradeScreen : Window
    {
        ...
        private void OnClick_Sell(object sender, RoutedEventArgs e)
        {
            ...
            if (groupedInventoryItem != null)
            {
                ...
                //Checking Trader's amount of gold and substracting after item sell
                //with this, Trader needs to replenish gold after some time - work on that
                //
                //if (Session.CurrentTrader.Gold >= groupedInventoryItem.Item.Price)
                //{
                //    Session.CurrentTrader.SpendGold(groupedInventoryItem.Item.Price);
                //    Session.CurrentPlayer.ReceiveGold(groupedInventoryItem.Item.Price);
                //    Session.CurrentTrader.AddItemToInventory(groupedInventoryItem.Item);
                //    Session.CurrentPlayer.RemoveItemFromInventory(groupedInventoryItem.Item);
                //}
                //else
                //{
                //    MessageBox.Show("Trader does not have enough gold");
                //}
            }
        }
